        ...
        const content = `
            <div class="card rounded shadoe">
                ...
                <div class="card-body">
                    ...
                    <button type="button" id="LikeBtnClicked" onclick="LikePost()" class="btn btn-outline-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
